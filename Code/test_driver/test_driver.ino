...
void loop() {
  ...
  if (leftPunchTimer > 0 and leftPunchTimer < 50) {
    leftPunchTimer -= 1;
  }

  if (rightPunchTimer > 0 and rightPunchTimer < 50) {
    rightPunchTimer -= 1;
  }
...
void leftPunchCheck() {
  ...
  if (lsm.accelData.y > 20000 and leftPunchTimer == 50) {
...
void rightPunchCheck() {
  ...
  if (lsm.accelData.y > 20000 and rightPunchTimer == 50) {
